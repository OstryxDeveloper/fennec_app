...
class OtpVerificationRoute extends _i9.PageRouteInfo<void> {
  const OtpVerificationRoute({List<_i9.PageRouteInfo>? children})
  ...
  static _i9.PageInfo page = _i9.PageInfo(
    name,
    builder: (data) {
      return const _i6.OtpVerificationScreen();
    },
  );
}
